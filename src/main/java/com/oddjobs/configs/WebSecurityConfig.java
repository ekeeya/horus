...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.
                ...
                .requestMatchers("/api/v1/users/prospect/register").permitAll()
                .requestMatchers("/api/v1/website/faqs/register").permitAll()
                .requestMatchers("/api/v1/website/faqs").permitAll()
                .requestMatchers("/api/v1/website/feedbacks/register").permitAll()
                .requestMatchers("/api/v1/website/feedbacks").permitAll()
                .requestMatchers("/api/v1/mm/callback/flutter-wave").permitAll()
                .requestMatchers("/api/v1/mm/callback/easy-pay").permitAll()
