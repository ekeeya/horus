...
public class PosCenterNotFoundException extends   Exception{

    public PosCenterNotFoundException(Long id) {
        super(String.format("No PosCenter of id %s found in the database", id));
    }
