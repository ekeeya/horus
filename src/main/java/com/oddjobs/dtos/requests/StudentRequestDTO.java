...
public class StudentRequestDTO extends BaseRequest {
    ...
    public StudentRequestDTO(Long id,String image, String firstName, String lastName, String middleName, String regNo, String classRoom, Long school, Long parent, Boolean editing) {
        this.id=id;
        this.image = image;
