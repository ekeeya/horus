...
const Home = () => {
  ...
  const [frequentAmounts, setFrequentAmounts] = useState([
    500, 1000, 1500, 2000, 3000, 4000, 5000, 10000, 20000, 50000,
  ]);
  ...
  const {cardDetails, paymentAmount, paid} = useSelector(
    store => store.payment,
  );
        ...
        <View style={styles.freqAmountContainer}>
          <ScrollView>
            <SimpleGrid
              ...
              renderItem={({item}) => (
                <TouchableOpacity
                  onPress={() => handleSetAmount(item)}
                  style={styles.freqAmount}>
      ...
      <View style={styles.bottomMost}>
        <View style={styles.scanButtonContainer}>
          <TouchableOpacity onPress={readNdef} style={styles.scanButton}>
            <Image
              source={require('../assests/contactless.png')}
