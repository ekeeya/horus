import {
  require_prop_types
} from "./chunk-I2QMS7LR.js";
import "./chunk-MQESS3JL.js";
import {
  require_react
...
var require_react_numeric_input = __commonJS({
  "node_modules/react-numeric-input/index.js"(exports, module) {
    init_virtual_process_polyfill();
    init_buffer();
        ...
        var NumericInput = function(_Component) {
          ...
          _createClass(NumericInput2, [{
            ...
            value: function _step(n, callback) {
              ...
              this._isStrict = true;
              var _step2 = +access(this.props, "step", NumericInput2.defaultProps.step, this, n > 0 ? NumericInput2.DIRECTION_UP : NumericInput2.DIRECTION_DOWN);
              var _n = this._toNumber((this.state.value || 0) + _step2 * n);
              if (this.props.snap) {
            ...
            value: function render() {
              ...
              for (var x in NumericInput2.style) {
                css[x] = _extends({}, NumericInput2.style[x], style ? style[x] || {} : {});
              }
...
export default require_react_numeric_input();
//# sourceMappingURL=react-numeric-input.js.map
